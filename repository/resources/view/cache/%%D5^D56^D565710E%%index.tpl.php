<?php /* Smarty version 2.6.26, created on 2015-08-31 16:14:10
         compiled from front/informatie/index.tpl */ ?>
<article id="content">
	<div class="container">
		<div class="col-xs-12 col-sm-6 col-lg-8 content">
			<h2>Wat moet je doen?</h2>
			<p>Als je kans wilt maken op de renovatiecheque hoef je slechts je persoonsgegevens in te vullen en een foto van je keuken te uploaden. Je krijgt vervolgens een bevestigingsmail met tips om zoveel mogelijk stemmen voor jouw inzending in te zamelen.</p>
			<ul>
				<li>Stap 1: Upload je foto</li>
				<li>Stap 2: Vul je gegevens in</li>
				<li>Stap 3: Laat je vrienden op je inzending stemmen!</li>
			</ul>
			<p>Als je alles netjes hebt ingezonden zal je moeten zorgen dat er zoveel mogelijk vrienden en andere bekenden op jouw inzending gaan stemmen. Aan het einde van de actieperiode wordt de winnaar met de meeste stemmen via Facebook bekend gemaakt. Daarnaast belonen we de meest creatieve en originele inzending ook nog eens met een renovatiecheque t.w.v. &euro; 750,-. Een vakman van I-KOOK zal contact met je zoeken om een afspraak te maken.</p>
			<h2>Wat kun je winnen?</h2>
			<p>De winnaars van de actie ontvangen een renovatiecheque t.w.v. &euro; 750,-. Tijdens een afspraak met de lokale vakman van I-KOOK zal gekeken worden hoe deze het best kan worden besteed.</p>
